...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="relative inline-flex items-center justify-center h-9 w-9 rounded-xl border cursor-pointer transition-all duration-300 hover:scale-105 shrink-0"
      style={{
